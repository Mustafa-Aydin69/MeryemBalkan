...
export default function AdminPanel() {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col items-center px-8 py-6">
          <div className="flex justify-between items-center w-full mb-4">
            ...
            <div className="text-center">
              <h1
                className={`text-xl font-light tracking-[0.3em] font-serif transition-colors italic ${
      ...
      <main
        className={`pt-32 pb-16 px-8 transition-colors duration-300 ${
              ...
              <div className="overflow-x-auto">
                ...
                >
                  <thead>
                    ...
                    >
                      <th
                        className={`text-left p-3 sm:p-4 font-medium text-xs sm:text-sm ${
                          isDarkMode ? 'text-white' : 'text-black'
                        }`}
                      >
                        SİPARİŞ NO
                      ...
                      <th
                        className={`text-left p-3 sm:p-4 font-medium text-xs sm:text-sm hidden md:table-cell ${
                          isDarkMode ? 'text-white' : 'text-black'
                        }`}
                      >
                        ÜRÜN
                      ...
                      <th
                        className={`text-left p-3 sm:p-4 font-medium text-xs sm:text-sm hidden xl:table-cell ${
                          isDarkMode ? 'text-white' : 'text-black'
                        }`}
                      >
                        DETAYLAR
                      ...
                      <th
                        className={`text-center p-3 sm:p-4 font-medium text-xs sm:text-sm ${
                          isDarkMode ? 'text-white' : 'text-black'
                        }`}
                      >
                        İŞLEM
                  ...
                  <tbody>
                    {orders.map((order) => (
                      ...
                      >
                        ...
                        <td
                          className={`p-3 sm:p-4 text-xs sm:text-sm hidden md:table-cell ${
                            isDarkMode ? 'text-white' : 'text-black'
                          }`}
                        >
                        ...
                        <td
                          className={`p-3 sm:p-4 text-xs sm:text-sm hidden xl:table-cell ${
                            isDarkMode ? 'text-white' : 'text-black'
                          }`}
                        >
      ...
      {isAddProductModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div
            className={`rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto transition-colors ${
              isDarkMode ? 'bg-gray-800' : 'bg-white'
            }`}
          >
            <div
            ...
            <form id="add-product-form" onSubmit={handleProductSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border focus:outline-none text-sm transition-colors ${
                      isDarkMode ? 'bg-gray-700 border-gray-600 text-white focus:border-white' : 'bg-white border-gray-300 text-black focus:border-black'
                    }`}
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className={`w-full px-4 py-3 border focus:outline-none text-sm pr-8 transition-colors ${
                      isDarkMode ? 'bg-gray-700 border-gray-600 text-white focus:border-white' : 'bg-white border-gray-300 text-black focus:border-black'
                    }`}
                  >
                    ...
                    <option value="gunluk">Günlük Giyim</option>
                    <option value="is">İş Kıyafetleri</option>
                  </select>
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={500}
                  required
                  className={`w-full px-4 py-3 border focus:outline-none text-sm resize-vertical transition-colors ${
                    isDarkMode ? 'bg-gray-700 border-gray-600 text-white focus:border-white' : 'bg-white border-gray-300 text-black focus:border-black'
                  }`}
                ></textarea>
                <div
                ...
                <div className="flex gap-2 mb-3">
                  <button
                    ...
                    className={`px-4 py-2 text-sm rounded border cursor-pointer whitespace-nowrap transition-colors ${
                      newProduct.sizes.includes('36-40')
                        ? isDarkMode
              ...
              <div>
                ...
                >
                  Ürün Fotoğrafları (En fazla 10 adet)
                </label>
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={newProduct.imagePreviews.length >= 10}
                  ...
                  >
                    ...
                    <span className="text-sm">
                      {newProduct.imagePreviews.length >= 10 ? 'Maksimum Limit Aşıldı' : 'Fotoğraf Seç'}
                    </span>
                    <span className="text-xs mt-1">
                      {newProduct.imagePreviews.length}/10 fotoğraf
                    </span>
                  </button>
                      ...
                      {newProduct.imagePreviews.map((preview, index) => (
                        <div key={index} className="relative group">
                          ...
                          <button
                            ...
                            className={`absolute -top-2 -right-2 w-6 h-6 rounded-full flex items-center justify-center cursor-pointer transition-all opacity-0 group-hover:opacity-100 shadow-md ${
                              isDarkMode
                          ...
                          <div
                            className={`absolute bottom-1 right-1 text-xs px-1.5 py-0.5 rounded text-white bg-black bg-opacity-70 ${
                              isDarkMode ? 'bg-white bg-opacity-90 text-black' : ''
                            }`}
                          >
                            {index + 1}
                          </div>
              ...
              <button
                type="submit"
                className={`w-full py-4 tracking-wide font-medium transition-colors whitespace-nowrap rounded-full ${
                  isDarkMode ? 'bg-white text-black hover:bg-gray-100' : 'bg-black text-white hover:bg-gray-800'
                }`}
              >
                ÜRÜN EKLE
      ...
      {editingProduct && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div
            className={`rounded-lg max-w-md w-full transition-colors ${
              isDarkMode ? 'bg-gray-800' : 'bg-white'
            }`}
          >
            <div
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-lg border text-sm font-medium transition-colors cursor-pointer whitespace-nowrap ${
              ...
              <div className="flex gap-3 mt-6">
                <button
                  onClick={() => setEditingProduct(null)}
                  className={`flex-1 py-3 px-4 rounded-full border font-medium transition-colors whitespace-nowrap ${
                    isDarkMode ? 'border-gray-600 text-white hover:bg-gray-700' : 'border-gray-300 text-black hover:bg-gray-50'
                  }`}
                >
                  İptal
                </button>
                <button
                  ...
                  className={`flex-1 py-3 px-4 rounded-full font-medium transition-colors whitespace-nowrap ${
                    isDarkMode ? 'bg-white text-black hover:bg-gray-100' : 'bg-black text-white hover:bg-gray-800'
                  }`}
                >
                  Güncelle
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-lg border text-sm font-medium transition-colors cursor-pointer whitespace-nowrap text-left ${
